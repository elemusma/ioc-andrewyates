...
function andrew_yates_stylesheets() {
...
if(is_page()) {
wp_enqueue_style('page-css', get_theme_file_uri('/css/sections/page.css'));
}
...
add_action('wp_enqueue_scripts', 'andrew_yates_stylesheets');
// for footer
function andrew_yates_stylesheets_footer() {
	...
	wp_enqueue_script('vimeo-player-js', '//player.vimeo.com/api/player.js');
	wp_enqueue_script('popup-js', get_theme_file_uri('/js/popup.js'));

	wp_enqueue_script('venobox-min-js', get_theme_file_uri('/venobox/venobox.min.js'));
	wp_enqueue_script('venobox-js', get_theme_file_uri('/venobox/venobox.js'));
...
add_action('get_footer', 'andrew_yates_stylesheets_footer');
...
add_action('after_setup_theme', 'andrew_yates_menus');
